...
function _configRecetarioFormulario() {
  return {
    ...
    fuente:document.getElementById('u-rec-fuente')?.value||'Arial',
...
function _resetRecetarioUsuario(_url, config) {
  ...
  document.getElementById('u-rec-fuente').value=['Arial','Georgia','Times New Roman','Verdana','Trebuchet MS','Courier New'].includes(cfg.fuente)?cfg.fuente:'Arial';
